...
export interface SkillCandidate extends TierCandidateBase {
  ...
  updatedAt?: EpochMs;
  // Originating profile so renderer can attribute "(learned by sergio)" when
  // skills are shared across agents. Added 2026-05-17 — see Hermes
  // memos-setup/learnings/2026-05-17-v2-only-bge-shares.md (Attribution
  // Patch).
