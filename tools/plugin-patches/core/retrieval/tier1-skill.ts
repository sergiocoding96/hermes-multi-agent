  ...
  try {
    ...
    for (const [id, state] of merged) {
      ...
      kept.push({
        ...
        // Origin attribution — surfaced into the rendered prompt as
        // "(learned by <profile>)" by injector.ts. Added 2026-05-17.
        ownerProfileId: sk.ownerProfileId,
        ownerAgentKind: sk.ownerAgentKind,
