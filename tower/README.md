# Hermes Tower (ops pack)

Operations documentation and scripts for **Tower** — Hermes multi-agent Discord + MemOS on host **`sergio`**.

**Live runtime** (not in git): `~/.hermes/profiles/`, profile `.env` secrets, `agents-auth.json` on the server.
