#!/usr/bin/env bash
# install-hermes-adapter.sh  [ARCHIVED — OBSOLETE as of 2026-04-21]
#
# This script is no longer needed. The hermes_local adapter ships bundled
# with paperclipai >= 2026.416.0 and appears in GET /api/adapters
# automatically — nothing to install.
#
# Kept for historical reference only. Use scripts/paperclip/v2/ instead.
# See scripts/paperclip/v2/README.md for the current setup flow.
#
